...
export const TarefaItem = ({
  ...
  const color = (new Date(tarefa.expiredAt) < new Date()) ? "red" : "black";
  const border = (new Date(tarefa.expiredAt) < new Date()) ? "1px solid red" : "none";
  const textDecoration = (new Date(tarefa.expiredAt) < new Date()) ? "line-through" : "none";
